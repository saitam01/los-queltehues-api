...
public class TokenProvider {
    ...
    @Autowired
    public TokenProvider(SecurityConfig securityConfig) {
        this.securityConfig = securityConfig;
    }

    @PostConstruct
    public void init() {
        byte[] keyBytes = Decoders.BASE64.decode(securityConfig.getSecret());
    ...
    public User getUser(String token) {
        ...
        User user = new User(claims.get("username", String.class),
